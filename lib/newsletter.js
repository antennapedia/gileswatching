...
var Poster = exports.Poster = function Poster(tag, count, type, site)
{
	Tag.call(this, tag, count);
	this.type = type;
	this.site = site;
...
var Item = exports.Item = function Item(bookmark)
{
...
{
	return this.category.sortkey() + '_' + bookmark.time + '_' + bookmark.description;
};

Item.prototype.posterlinks = function(ljtags)
{
	console.log(this.posters.length, this.posters);
